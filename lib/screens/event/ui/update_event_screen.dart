...
class UpdateEventScreen extends StatefulWidget {
  ...
  EventData eventData;
   UpdateEventScreen( {Key? key,required this.eventData, required this.eventID,}) : super(key: key);
  @override
  State<StatefulWidget> createState() => _UpdateEventState(eventData,eventID);
}
...
class _UpdateEventState extends State<UpdateEventScreen> {
  ...
  _UpdateEventState(this.eventData, this.eventID);
  ...
  void initState() {
    ...
    _controllerPlace.text= eventData.place;
    _controllerDescription.text= eventData.description;
    _controllerTitle.text= eventData.title;
  }
        ...
        child: Padding(
          ...
          child: Form(
            ...
            child: Consumer(builder: ((context, ref, child) {
              ...
              ref.read(createEventProvider).setNewDateTime(eventData.dateTime);

              ref.read(createEventProvider).setDropDownValue(eventData.eventTpye);
                  ...
                  PrimaryButton(
                      ...
                      onPressed: () async {
                        ...
                        if (isValid(dateTime)) {
                          ...
                          ref.read(createEventProvider).updateEvent(
                              context: context,
                              title: title ?? "",
                              description: description ?? "",
                              place: place ?? "", eventID: eventID);
                        }
                      })
                ],
              );
